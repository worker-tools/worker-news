...
router.get('/news.css', () => {
  const response = new HTMLResponse(css`
    ...
    body  { font-family:Verdana, Geneva, sans-serif; font-size:10pt; color:var(--text); }
    td    { font-family:Verdana, Geneva, sans-serif; font-size:10pt; color:var(--text); }
    ...
    .default { font-family:Verdana, Geneva, sans-serif; font-size: 10pt; color:var(--text); }
    .admin   { font-family:Verdana, Geneva, sans-serif; font-size:8.5pt; color:var(--text-strong); }
    .title   { font-family:Verdana, Geneva, sans-serif; font-size: 10pt; color:var(--text); }
    .subtext { font-family:Verdana, Geneva, sans-serif; font-size:  7pt; color:var(--text); }
    ...
    .comhead { font-family:Verdana, Geneva, sans-serif; font-size:  8pt; color:var(--text); }
    ...
    .votearrow {
      ...
      border:     0px;
      margin:     3px 2px 6px;
      background: url("https://jgthms.com/hacker-news-dark-mode/images/grayarrow.gif")
      no-repeat;
    }
